# Computation used to train notable artificial intelligence systems, by domain - Data package

This data package contains the data that powers the chart ["Computation used to train notable artificial intelligence systems, by domain"](https://ourworldindata.org/grapher/artificial-intelligence-training-computation?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
...
Computation is measured in total petaFLOP, which is 10¹⁵ [floating-point operations](#dod:flop) estimated from AI literature, albeit with some uncertainty.
...
#### Full citation
Epoch (2024) – with major processing by Our World in Data. “Training computation (petaFLOP)” [dataset]. Epoch, “Parameter, Compute and Data Trends in Machine Learning” [original data].
Source: Epoch (2024) – with major processing by Our World In Data
...
#### Epoch – Parameter, Compute and Data Trends in Machine Learning
Retrieved on: 2024-11-03  
Retrieved from: https://epoch.ai/mlinputs/visualization  


## Domain
Refers to the specific area, application, or field in which an AI system is designed to operate.
Last updated: November 3, 2024  
Next update: December 2024  
...
#### Full citation
Epoch (2024) – with major processing by Our World in Data. “Domain” [dataset]. Epoch, “Parameter, Compute and Data Trends in Machine Learning” [original data].
Source: Epoch (2024) – with major processing by Our World In Data
